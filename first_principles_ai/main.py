...
from agent.science_campaign_strategy import (
    build_science_campaign_strategy_plan,
    load_plain_json as load_science_campaign_strategy_plain_json,
...
from agent.science_campaign_strategy_outcome import (
    build_science_campaign_strategy_outcome_assessment,
    load_plain_json as load_science_campaign_strategy_outcome_plain_json,
...
from agent.science_campaign_cycle_strategy_outcome import (
    build_science_campaign_cycle_strategy_outcome_assessment,
    load_plain_json as load_science_campaign_cycle_strategy_outcome_plain_json,
...
from agent.science_coordination_history import (
    build_science_coordination_history_export,
    load_plain_json as load_science_coordination_history_plain_json,
...
from agent.science_coordination_policy import (
    build_science_coordination_policy_recommendation,
    load_plain_json as load_science_coordination_policy_plain_json,
...
from agent.science_coordination_policy_outcome import (
    build_science_coordination_policy_outcome_assessment,
    load_plain_json as load_science_coordination_policy_outcome_plain_json,
...
from agent.science_coordination_ab_probe import (
    build_science_coordination_ab_probe_plan,
    load_plain_json as load_science_coordination_ab_probe_plain_json,
...
from agent.science_coordination_ab_probe_outcome import (
    build_science_coordination_ab_probe_outcome_assessment,
    load_plain_json as load_science_coordination_ab_probe_outcome_plain_json,
...
from agent.science_history_guided_policy import (
    build_science_history_guided_policy_plan,
    load_plain_json as load_science_history_guided_policy_plain_json,
...
from agent.science_history_guided_policy_outcome import (
    build_science_history_guided_policy_outcome_assessment,
    load_plain_json as load_science_history_guided_policy_outcome_plain_json,
...
from agent.science_history_guided_policy_retention import (
    build_science_history_guided_policy_retention_scorecard,
    load_plain_json as load_science_history_guided_policy_retention_plain_json,
...
from agent.science_retained_policy_replay import (
    build_science_retained_policy_replay_evaluation,
    load_plain_json as load_science_retained_policy_replay_plain_json,
...
def run_science_campaign_strategy_planner(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_strategy_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Plan the next durable campaign strategy from frontier outcomes."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_campaign_strategy_transcript(transcript_file)
    frontier_outcome_ledger = load_science_campaign_strategy_plain_json(frontier_outcome_ledger_file)
    frontier_ledger = load_science_campaign_strategy_plain_json(frontier_ledger_file)
    campaign_ledger = load_science_campaign_strategy_plain_json(campaign_ledger_file)
    theory_memory_ledger = (
        load_science_campaign_strategy_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_campaign_strategy_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_campaign_strategy_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_campaign_strategy_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    strategy_ledger = load_science_campaign_strategy_ledger(strategy_ledger_file)
    prior_strategy_ledger = (
        load_science_campaign_strategy_plain_json(prior_strategy_ledger_file)
        if prior_strategy_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_campaign_strategy_plan(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        prior_strategy_ledger=prior_strategy_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=strategy_ledger_file,
    )
    write_science_campaign_strategy_ledger(strategy_ledger_file, updated_ledger)
    if outbox_file:
        write_science_campaign_strategy_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_campaign_strategy_capability': True,
        'strategy_ledger_path': str(strategy_ledger_file),
        'strategy_ledger_hash': updated_ledger.get('ledger_hash'),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_CAMPAIGN_STRATEGY "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_campaign_strategy_outcome_assessor(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_strategy_outcome_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Assess whether a planned science campaign strategy changed state."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_campaign_strategy_outcome_transcript(transcript_file)
    strategy_ledger = load_science_campaign_strategy_outcome_plain_json(strategy_ledger_file)
    frontier_outcome_ledger = load_science_campaign_strategy_outcome_plain_json(frontier_outcome_ledger_file)
    frontier_ledger = load_science_campaign_strategy_outcome_plain_json(frontier_ledger_file)
    campaign_ledger = load_science_campaign_strategy_outcome_plain_json(campaign_ledger_file)
    theory_memory_ledger = (
        load_science_campaign_strategy_outcome_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_campaign_strategy_outcome_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_campaign_strategy_outcome_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_campaign_strategy_outcome_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    strategy_outcome_ledger = load_science_campaign_strategy_outcome_ledger(strategy_outcome_ledger_file)
    prior_strategy_outcome_ledger = (
        load_science_campaign_strategy_outcome_plain_json(prior_strategy_outcome_ledger_file)
        if prior_strategy_outcome_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_campaign_strategy_outcome_assessment(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_strategy_outcome_ledger=prior_strategy_outcome_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=strategy_outcome_ledger_file,
    )
    write_science_campaign_strategy_outcome_ledger(strategy_outcome_ledger_file, updated_ledger)
    if outbox_file:
        write_science_campaign_strategy_outcome_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_campaign_strategy_outcome_capability': True,
        'strategy_outcome_ledger_path': str(strategy_outcome_ledger_file),
        'strategy_outcome_ledger_hash': updated_ledger.get('ledger_hash'),
        'campaign_strategy_outcome_id': latest.get('campaign_strategy_outcome_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_CAMPAIGN_STRATEGY_OUTCOME "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_campaign_cycle_strategy_outcome_assessor(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_cycle_strategy_outcome_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Assess whether a science campaign cycle strategy changed state."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_campaign_cycle_strategy_outcome_transcript(transcript_file)
    cycle_strategy_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(cycle_strategy_ledger_file)
    strategy_outcome_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(strategy_outcome_ledger_file)
    strategy_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(strategy_ledger_file)
    frontier_outcome_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(frontier_outcome_ledger_file)
    frontier_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(frontier_ledger_file)
    campaign_ledger = load_science_campaign_cycle_strategy_outcome_plain_json(campaign_ledger_file)
    theory_memory_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_cycle_memory_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(campaign_cycle_memory_ledger_file)
        if campaign_cycle_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    cycle_strategy_outcome_ledger = load_science_campaign_cycle_strategy_outcome_ledger(cycle_strategy_outcome_ledger_file)
    prior_cycle_strategy_outcome_ledger = (
        load_science_campaign_cycle_strategy_outcome_plain_json(prior_cycle_strategy_outcome_ledger_file)
        if prior_cycle_strategy_outcome_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_campaign_cycle_strategy_outcome_assessment(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_cycle_strategy_outcome_ledger=prior_cycle_strategy_outcome_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=cycle_strategy_outcome_ledger_file,
    )
    write_science_campaign_cycle_strategy_outcome_ledger(cycle_strategy_outcome_ledger_file, updated_ledger)
    if outbox_file:
        write_science_campaign_cycle_strategy_outcome_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_campaign_cycle_strategy_outcome_capability': True,
        'cycle_strategy_outcome_ledger_path': str(cycle_strategy_outcome_ledger_file),
        'cycle_strategy_outcome_ledger_hash': updated_ledger.get('ledger_hash'),
        'campaign_cycle_strategy_outcome_id': latest.get('campaign_cycle_strategy_outcome_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        ...
        'close_count': int(state_counts.get('close', 0) or 0),
        'schedule_count': int(state_counts.get('schedule', 0) or 0),
        'strengthen_count': int(state_counts.get('strengthen', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'selected_outcome': latest.get('selected_outcome'),
        'selected_action': latest.get('selected_action'),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_CAMPAIGN_CYCLE_STRATEGY_OUTCOME "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_coordination_history_exporter(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_history_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Export local science coordination payoff records for history."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_coordination_history_transcript(transcript_file)
    cycle_strategy_outcome_ledger = load_science_coordination_history_plain_json(cycle_strategy_outcome_ledger_file)
    cycle_strategy_ledger = load_science_coordination_history_plain_json(cycle_strategy_ledger_file)
    strategy_outcome_ledger = load_science_coordination_history_plain_json(strategy_outcome_ledger_file)
    strategy_ledger = load_science_coordination_history_plain_json(strategy_ledger_file)
    frontier_outcome_ledger = load_science_coordination_history_plain_json(frontier_outcome_ledger_file)
    frontier_ledger = load_science_coordination_history_plain_json(frontier_ledger_file)
    theory_memory_ledger = (
        load_science_coordination_history_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_cycle_memory_ledger = (
        load_science_coordination_history_plain_json(campaign_cycle_memory_ledger_file)
        if campaign_cycle_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_coordination_history_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_coordination_history_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_coordination_history_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_coordination_history_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    history_ledger = load_science_coordination_history_ledger(history_ledger_file)
    prior_history_ledger = (
        load_science_coordination_history_plain_json(prior_history_ledger_file)
        if prior_history_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_coordination_history_export(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_history_ledger=prior_history_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=history_ledger_file,
    )
    write_science_coordination_history_ledger(history_ledger_file, updated_ledger)
    if outbox_file:
        write_science_coordination_history_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_coordination_history_capability': True,
        'history_ledger_path': str(history_ledger_file),
        'history_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_coordination_history_id': latest.get('science_coordination_history_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'payoff_count': int(state_counts.get('payoff', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'rework_count': int(state_counts.get('rework', 0) or 0),
        'sibling_count': int(state_counts.get('sibling', 0) or 0),
        'request_count': int(state_counts.get('request', 0) or 0),
        'payoff_class': latest.get('payoff_class'),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_COORDINATION_HISTORY "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_coordination_policy_recommender(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_policy_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Recommend cautious science-side coordination policy from history."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_coordination_policy_transcript(transcript_file)
    history_ledger = load_science_coordination_policy_plain_json(history_ledger_file)
    cycle_strategy_outcome_ledger = load_science_coordination_policy_plain_json(cycle_strategy_outcome_ledger_file)
    cycle_strategy_ledger = load_science_coordination_policy_plain_json(cycle_strategy_ledger_file)
    strategy_outcome_ledger = load_science_coordination_policy_plain_json(strategy_outcome_ledger_file)
    strategy_ledger = load_science_coordination_policy_plain_json(strategy_ledger_file)
    frontier_outcome_ledger = load_science_coordination_policy_plain_json(frontier_outcome_ledger_file)
    theory_memory_ledger = (
        load_science_coordination_policy_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_cycle_memory_ledger = (
        load_science_coordination_policy_plain_json(campaign_cycle_memory_ledger_file)
        if campaign_cycle_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_coordination_policy_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_coordination_policy_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_coordination_policy_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    policy_ledger = load_science_coordination_policy_ledger(policy_ledger_file)
    prior_policy_ledger = (
        load_science_coordination_policy_plain_json(prior_policy_ledger_file)
        if prior_policy_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_coordination_policy_recommendation(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        campaign_ledger=campaign_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_policy_ledger=prior_policy_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=policy_ledger_file,
    )
    write_science_coordination_policy_ledger(policy_ledger_file, updated_ledger)
    if outbox_file:
        write_science_coordination_policy_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_coordination_policy_capability': True,
        'policy_ledger_path': str(policy_ledger_file),
        'policy_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_coordination_policy_id': latest.get('science_coordination_policy_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'code_count': int(state_counts.get('code', 0) or 0),
        ...
        'language_count': int(state_counts.get('language', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'avoid_count': int(state_counts.get('avoid', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'schedule_count': int(state_counts.get('schedule', 0) or 0),
        'selected_policy': latest.get('selected_policy'),
        'selected_action': latest.get('selected_action'),
        'recommendation_strength': latest.get('recommendation_strength'),
        'chosen_recipient': latest.get('chosen_recipient'),
        'outbox_count': int(latest.get('outbox_count', 0) or 0),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_COORDINATION_POLICY "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_coordination_policy_outcome_assessor(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_policy_outcome_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Assess whether science coordination policies changed symbolic outcomes."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_coordination_policy_outcome_transcript(transcript_file)
    policy_ledger = load_science_coordination_policy_outcome_plain_json(policy_ledger_file)
    history_ledger = load_science_coordination_policy_outcome_plain_json(history_ledger_file)
    cycle_strategy_outcome_ledger = load_science_coordination_policy_outcome_plain_json(cycle_strategy_outcome_ledger_file)
    cycle_strategy_ledger = load_science_coordination_policy_outcome_plain_json(cycle_strategy_ledger_file)
    strategy_outcome_ledger = load_science_coordination_policy_outcome_plain_json(strategy_outcome_ledger_file)
    frontier_outcome_ledger = load_science_coordination_policy_outcome_plain_json(frontier_outcome_ledger_file)
    theory_memory_ledger = (
        load_science_coordination_policy_outcome_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_cycle_memory_ledger = (
        load_science_coordination_policy_outcome_plain_json(campaign_cycle_memory_ledger_file)
        if campaign_cycle_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_coordination_policy_outcome_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_coordination_policy_outcome_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_coordination_policy_outcome_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_coordination_policy_outcome_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    policy_outcome_ledger = load_science_coordination_policy_outcome_ledger(policy_outcome_ledger_file)
    prior_policy_outcome_ledger = (
        load_science_coordination_policy_outcome_plain_json(prior_policy_outcome_ledger_file)
        if prior_policy_outcome_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    updated_ledger, message = build_science_coordination_policy_outcome_assessment(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_policy_outcome_ledger=prior_policy_outcome_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        artifact_path=policy_outcome_ledger_file,
    )
    write_science_coordination_policy_outcome_ledger(policy_outcome_ledger_file, updated_ledger)
    if outbox_file:
        write_science_coordination_policy_outcome_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_coordination_policy_outcome_capability': True,
        'policy_outcome_ledger_path': str(policy_outcome_ledger_file),
        'policy_outcome_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_coordination_policy_outcome_id': latest.get('science_coordination_policy_outcome_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'code_count': int(state_counts.get('code', 0) or 0),
        'funfun_count': int(state_counts.get('funfun', 0) or 0),
        'language_count': int(state_counts.get('language', 0) or 0),
        'theory_count': int(state_counts.get('theory', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        ...
        'selected_outcome': latest.get('selected_outcome'),
        'selected_action': latest.get('selected_action'),
        'policy_retention_state': latest.get('policy_retention_state'),
        'chosen_recipient': latest.get('chosen_recipient'),
        'outbox_count': int(latest.get('outbox_count', 0) or 0),
        'outbox_file': str(outbox_file) if outbox_file else None,
        'response_message': message,
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_COORDINATION_POLICY_OUTCOME "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_coordination_ab_probe_planner(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_ab_probe_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Plan a bounded science coordination A/B probe from scorecards."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_coordination_ab_probe_transcript(transcript_file)
    scorecard_ledger = load_science_coordination_ab_probe_plain_json(scorecard_ledger_file)
    policy_outcome_ledger = load_science_coordination_ab_probe_plain_json(policy_outcome_ledger_file)
    policy_ledger = load_science_coordination_ab_probe_plain_json(policy_ledger_file)
    history_ledger = load_science_coordination_ab_probe_plain_json(history_ledger_file)
    cycle_strategy_outcome_ledger = load_science_coordination_ab_probe_plain_json(cycle_strategy_outcome_ledger_file)
    theory_memory_ledger = (
        load_science_coordination_ab_probe_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_cycle_memory_ledger = (
        load_science_coordination_ab_probe_plain_json(campaign_cycle_memory_ledger_file)
        if campaign_cycle_memory_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_coordination_ab_probe_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_coordination_ab_probe_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_coordination_ab_probe_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    ab_probe_ledger = load_science_coordination_ab_probe_ledger(ab_probe_ledger_file)
    prior_ab_probe_ledger = (
        load_science_coordination_ab_probe_plain_json(prior_ab_probe_ledger_file)
        if prior_ab_probe_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_coordination_ab_probe_plan(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_ab_probe_ledger=prior_ab_probe_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=ab_probe_ledger_file,
    )
    write_science_coordination_ab_probe_ledger(ab_probe_ledger_file, updated_ledger)
    if outbox_file:
        write_science_coordination_ab_probe_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_coordination_ab_probe_capability': True,
        'ab_probe_ledger_path': str(ab_probe_ledger_file),
        'ab_probe_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_coordination_ab_probe_id': latest.get('science_coordination_ab_probe_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'scheduled_count': int(state_counts.get('scheduled', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'retired_count': int(state_counts.get('retired', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'selected_decision': latest.get('selected_probe_decision'),
        'selected_action': latest.get('selected_action'),
        'chosen_recipient': latest.get('chosen_recipient'),
        'outbox_count': int(latest.get('outbox_count', 0) or 0),
        'outbox_file': str(outbox_file) if outbox_file else None,
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_COORDINATION_AB_PROBE "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_coordination_ab_probe_outcome_assessor(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    prior_ab_probe_outcome_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Assess a bounded science coordination A/B probe outcome."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_coordination_ab_probe_outcome_transcript(transcript_file)
    ab_probe_ledger = load_science_coordination_ab_probe_outcome_plain_json(ab_probe_ledger_file)
    scorecard_ledger = load_science_coordination_ab_probe_outcome_plain_json(scorecard_ledger_file)
    policy_outcome_ledger = load_science_coordination_ab_probe_outcome_plain_json(policy_outcome_ledger_file)
    history_ledger = load_science_coordination_ab_probe_outcome_plain_json(history_ledger_file)
    cycle_strategy_outcome_ledger = load_science_coordination_ab_probe_outcome_plain_json(cycle_strategy_outcome_ledger_file)
    theory_memory_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    ab_probe_outcome_ledger = load_science_coordination_ab_probe_outcome_ledger(ab_probe_outcome_ledger_file)
    prior_ab_probe_outcome_ledger = (
        load_science_coordination_ab_probe_outcome_plain_json(prior_ab_probe_outcome_ledger_file)
        if prior_ab_probe_outcome_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_coordination_ab_probe_outcome_assessment(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_ab_probe_outcome_ledger=prior_ab_probe_outcome_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=ab_probe_outcome_ledger_file,
    )
    write_science_coordination_ab_probe_outcome_ledger(ab_probe_outcome_ledger_file, updated_ledger)
    if outbox_file:
        write_science_coordination_ab_probe_outcome_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_coordination_ab_probe_outcome_capability': True,
        'ab_probe_outcome_ledger_path': str(ab_probe_outcome_ledger_file),
        'ab_probe_outcome_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_coordination_ab_probe_outcome_id': latest.get('science_coordination_ab_probe_outcome_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'candidate_win_count': int(state_counts.get('candidate_win', 0) or 0),
        'control_win_count': int(state_counts.get('control_win', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'retired_count': int(state_counts.get('retired', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'selected_outcome': latest.get('selected_outcome_class'),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_COORDINATION_AB_PROBE_OUTCOME "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_history_guided_policy_planner(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    experiment_ledger_file: str | Path | None = None,
    module_chat_ledger_file: str | Path | None = None,
    history_guided_policy_ledger_file: str | Path = 'tmp/module-chat-science-history-guided-policy-ledger.json',
    prior_history_guided_policy_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Plan the next science policy from local interaction-history evidence."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_history_guided_policy_transcript(transcript_file)
    interaction_history_ledger = load_science_history_guided_policy_plain_json(interaction_history_ledger_file)
    ab_probe_outcome_ledger = load_science_history_guided_policy_plain_json(ab_probe_outcome_ledger_file)
    ab_probe_ledger = load_science_history_guided_policy_plain_json(ab_probe_ledger_file)
    policy_scorecard_ledger = load_science_history_guided_policy_plain_json(policy_scorecard_ledger_file)
    policy_outcome_ledger = load_science_history_guided_policy_plain_json(policy_outcome_ledger_file)
    history_ledger = load_science_history_guided_policy_plain_json(history_ledger_file)
    cycle_strategy_outcome_ledger = load_science_history_guided_policy_plain_json(cycle_strategy_outcome_ledger_file)
    theory_memory_ledger = (
        load_science_history_guided_policy_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_history_guided_policy_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_history_guided_policy_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_history_guided_policy_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_history_guided_policy_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    history_guided_policy_ledger = load_science_history_guided_policy_ledger(history_guided_policy_ledger_file)
    prior_history_guided_policy_ledger = (
        load_science_history_guided_policy_plain_json(prior_history_guided_policy_ledger_file)
        if prior_history_guided_policy_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_history_guided_policy_plan(
        transcript_messages=list(transcript.get('messages') or []),
        history_guided_policy_ledger=history_guided_policy_ledger,
        interaction_history_ledger=interaction_history_ledger,
        ab_probe_outcome_ledger=ab_probe_outcome_ledger,
        ab_probe_ledger=ab_probe_ledger,
        policy_scorecard_ledger=policy_scorecard_ledger,
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_history_guided_policy_ledger=prior_history_guided_policy_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=history_guided_policy_ledger_file,
    )
    write_science_history_guided_policy_ledger(history_guided_policy_ledger_file, updated_ledger)
    if outbox_file:
        write_science_history_guided_policy_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_history_guided_policy_capability': True,
        'history_guided_policy_ledger_path': str(history_guided_policy_ledger_file),
        'history_guided_policy_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_history_guided_policy_id': latest.get('science_history_guided_policy_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'applied_count': int(state_counts.get('applied', 0) or 0),
        'weakened_count': int(state_counts.get('weakened', 0) or 0),
        'retired_count': int(state_counts.get('retired', 0) or 0),
        'waiting_count': int(state_counts.get('waiting', 0) or 0),
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'selected_decision': latest.get('selected_policy_decision'),
        'selected_action': latest.get('selected_action'),
        'chosen_recipient': latest.get('chosen_recipient'),
        'outbox_count': int(latest.get('outbox_count', 0) or 0),
        'outbox_file': str(outbox_file) if outbox_file else None,
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_HISTORY_GUIDED_POLICY "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_history_guided_policy_outcome_assessor(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    experiment_ledger_file: str | Path | None = None,
    module_chat_ledger_file: str | Path | None = None,
    history_guided_policy_outcome_ledger_file: str | Path = 'tmp/module-chat-science-history-guided-policy-outcome-ledger.json',
    prior_history_guided_policy_outcome_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Assess whether a history-guided science policy changed symbolic outcomes."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_history_guided_policy_outcome_transcript(transcript_file)
    history_guided_policy_ledger = load_science_history_guided_policy_outcome_plain_json(history_guided_policy_ledger_file)
    interaction_history_ledger = load_science_history_guided_policy_outcome_plain_json(interaction_history_ledger_file)
    ab_probe_outcome_ledger = load_science_history_guided_policy_outcome_plain_json(ab_probe_outcome_ledger_file)
    ab_probe_ledger = load_science_history_guided_policy_outcome_plain_json(ab_probe_ledger_file)
    theory_memory_ledger = (
        load_science_history_guided_policy_outcome_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_history_guided_policy_outcome_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_history_guided_policy_outcome_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_history_guided_policy_outcome_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_history_guided_policy_outcome_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    policy_outcome_ledger = load_science_history_guided_policy_outcome_ledger(history_guided_policy_outcome_ledger_file)
    prior_policy_outcome_ledger = (
        load_science_history_guided_policy_outcome_plain_json(prior_history_guided_policy_outcome_ledger_file)
        if prior_history_guided_policy_outcome_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_history_guided_policy_outcome_assessment(
        transcript_messages=list(transcript.get('messages') or []),
        policy_outcome_ledger=policy_outcome_ledger,
        history_guided_policy_ledger=history_guided_policy_ledger,
        interaction_history_ledger=interaction_history_ledger,
        ...
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=history_guided_policy_outcome_ledger_file,
    )
    write_science_history_guided_policy_outcome_ledger(history_guided_policy_outcome_ledger_file, updated_ledger)
    if outbox_file:
        write_science_history_guided_policy_outcome_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_history_guided_policy_outcome_capability': True,
        'history_guided_policy_outcome_ledger_path': str(history_guided_policy_outcome_ledger_file),
        'history_guided_policy_outcome_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_history_guided_policy_outcome_id': latest.get('science_history_guided_policy_outcome_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'retained_count': int(state_counts.get('retained', 0) or 0),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_HISTORY_GUIDED_POLICY_OUTCOME "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_history_guided_policy_retention_scorecard(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    experiment_ledger_file: str | Path | None = None,
    module_chat_ledger_file: str | Path | None = None,
    retention_ledger_file: str | Path = 'tmp/module-chat-science-history-guided-policy-retention-ledger.json',
    prior_retention_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Aggregate history-guided policy outcomes into retention memory."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_history_guided_policy_retention_transcript(transcript_file)
    policy_outcome_ledger = load_science_history_guided_policy_retention_plain_json(history_guided_policy_outcome_ledger_file)
    history_guided_policy_ledger = load_science_history_guided_policy_retention_plain_json(history_guided_policy_ledger_file)
    interaction_history_ledger = load_science_history_guided_policy_retention_plain_json(interaction_history_ledger_file)
    ab_probe_outcome_ledger = load_science_history_guided_policy_retention_plain_json(ab_probe_outcome_ledger_file)
    ab_probe_ledger = load_science_history_guided_policy_retention_plain_json(ab_probe_ledger_file)
    theory_memory_ledger = (
        load_science_history_guided_policy_retention_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_history_guided_policy_retention_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_history_guided_policy_retention_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_history_guided_policy_retention_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_history_guided_policy_retention_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    retention_ledger = load_science_history_guided_policy_retention_ledger(retention_ledger_file)
    prior_retention_ledger = (
        load_science_history_guided_policy_retention_plain_json(prior_retention_ledger_file)
        if prior_retention_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_history_guided_policy_retention_scorecard(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_retention_ledger=prior_retention_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=retention_ledger_file,
    )
    write_science_history_guided_policy_retention_ledger(retention_ledger_file, updated_ledger)
    if outbox_file:
        write_science_history_guided_policy_retention_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_history_guided_policy_retention_capability': True,
        'retention_ledger_path': str(retention_ledger_file),
        'retention_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_history_guided_policy_retention_id': latest.get('science_history_guided_policy_retention_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'retained_count': int(state_counts.get('retained', 0) or 0),
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_HISTORY_GUIDED_POLICY_RETENTION "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
def run_science_retained_policy_replay_evaluator(
    theory_memory: CumulativeTheoryMemory | None = None,
    *,
    theory_memory_file: str | Path | None = None,
    runtime_memory_path: str = 'tmp/theory-memory.json',
    ...
    experiment_ledger_file: str | Path | None = None,
    module_chat_ledger_file: str | Path | None = None,
    replay_ledger_file: str | Path = 'tmp/module-chat-science-retained-policy-replay-ledger.json',
    prior_replay_ledger_file: str | Path | None = None,
    outbox_file: str | Path | None = None,
    output_file: str | Path | None = None,
    memory_data: dict | None = None,
    git_status_text: str | None = None,
    ...
    """Replay retained science policy memory against symbolic controls."""
    if memory_data is not None:
        loaded_memory = dict(memory_data)
    elif theory_memory is not None:
        loaded_memory = theory_memory.to_dict()
    ...
    transcript = read_science_retained_policy_replay_transcript(transcript_file)
    retention_ledger = load_science_retained_policy_replay_plain_json(retention_ledger_file)
    policy_outcome_ledger = load_science_retained_policy_replay_plain_json(history_guided_policy_outcome_ledger_file)
    history_guided_policy_ledger = load_science_retained_policy_replay_plain_json(history_guided_policy_ledger_file)
    interaction_history_ledger = load_science_retained_policy_replay_plain_json(interaction_history_ledger_file)
    theory_memory_ledger = (
        load_science_retained_policy_replay_plain_json(theory_memory_ledger_file)
        if theory_memory_ledger_file
        else {}
    )
    campaign_ledger = (
        load_science_retained_policy_replay_plain_json(campaign_ledger_file)
        if campaign_ledger_file
        else {}
    )
    hypothesis_ledger = (
        load_science_retained_policy_replay_plain_json(hypothesis_ledger_file)
        if hypothesis_ledger_file
        else {}
    )
    experiment_ledger = (
        load_science_retained_policy_replay_plain_json(experiment_ledger_file)
        if experiment_ledger_file
        else {}
    )
    module_chat_ledger = (
        load_science_retained_policy_replay_plain_json(module_chat_ledger_file)
        if module_chat_ledger_file
        else {}
    )
    replay_ledger = load_science_retained_policy_replay_ledger(replay_ledger_file)
    prior_replay_ledger = (
        load_science_retained_policy_replay_plain_json(prior_replay_ledger_file)
        if prior_replay_ledger_file
        else {}
    )
    before_hash = _file_sha256(runtime_memory_path)
    runtime_hash_state = _runtime_memory_hash_state(runtime_memory_path, before_hash)
    hf_status = {'hf_validation_used': bool(hf_validation_used)}
    updated_ledger, message = build_science_retained_policy_replay_evaluation(
        transcript_messages=list(transcript.get('messages') or []),
        ...
        experiment_ledger=experiment_ledger,
        module_chat_ledger=module_chat_ledger,
        prior_replay_ledger=prior_replay_ledger,
        runtime_memory_data=loaded_memory,
        runtime_memory_hash_state=runtime_hash_state,
        project_owned_boundary=dict(capsule.get('project_owned_boundary') or {}),
        hf_use_status=hf_status,
        artifact_path=replay_ledger_file,
    )
    write_science_retained_policy_replay_ledger(replay_ledger_file, updated_ledger)
    if outbox_file:
        write_science_retained_policy_replay_outbox_jsonl(outbox_file, message)
    latest = dict(updated_ledger.get('latest') or {})
    state_counts = dict(latest.get('state_counts') or {})
    result = {
        'science_retained_policy_replay_capability': True,
        'replay_ledger_path': str(replay_ledger_file),
        'replay_ledger_hash': updated_ledger.get('ledger_hash'),
        'science_retained_policy_replay_id': latest.get('science_retained_policy_replay_id'),
        'processed_message_count': len(updated_ledger.get('processed_message_ids') or []),
        'new_message_count': int(latest.get('new_message_count', 0) or 0),
        'skipped_message_count': int(latest.get('skipped_message_count', 0) or 0),
        'candidate_win_count': int(state_counts.get('candidate_win', 0) or 0),
        ...
        'boundary_count': int(state_counts.get('boundary', 0) or 0),
        'no_gain_count': int(state_counts.get('no_gain', 0) or 0),
        'selected_replay_class': latest.get('selected_replay_class'),
        'next_planner_recommendation': latest.get('next_planner_recommendation'),
        'selected_action': latest.get('selected_action'),
        'chosen_recipient': latest.get('chosen_recipient'),
        'outbox_count': int(latest.get('outbox_count', 0) or 0),
        'outbox_file': str(outbox_file) if outbox_file else None,
    ...
    if output_file:
        _write_json_artifact(output_file, result)
    print(
        "AI_DIFFERENT_SCIENCE_RETAINED_POLICY_REPLAY "
        + json.dumps(result, sort_keys=True),
        flush=True,
    )
    return result
...
if __name__ == '__main__':
    ...
    parser.add_argument('--module-chat-science-campaign-strategy', action='store_true',
    ...
    parser.add_argument('--module-chat-science-campaign-cycle-strategy-outcome', action='store_true',
                        help='Assess whether science campaign cycle strategies changed symbolic state')
    parser.add_argument('--module-chat-science-coordination-history', action='store_true',
                        help='Export local science coordination payoff records for the history participant')
    parser.add_argument('--module-chat-science-coordination-policy', action='store_true',
    ...
    parser.add_argument('--module-chat-science-coordination-ab-probe', action='store_true',
    ...
    parser.add_argument('--module-chat-science-history-guided-policy', action='store_true',
                        help='Plan the next science coordination policy from local interaction-history evidence')
    parser.add_argument('--module-chat-science-history-guided-policy-outcome', action='store_true',
                        help='Assess whether science history-guided policies changed symbolic outcomes')
    parser.add_argument('--module-chat-science-history-guided-policy-retention', action='store_true',
                        help='Aggregate repeated history-guided policy outcomes into retention scorecards')
    parser.add_argument('--module-chat-science-retained-policy-replay', action='store_true',
                        help='Replay retained science policy memory against symbolic control orderings')
    ...
    parser.add_argument('--module-chat-campaign-strategy-ledger-file', type=str,
                        default='tmp/module-chat-science-campaign-strategy-ledger.json',
                        help='JSON path for science campaign strategy planner state')
    parser.add_argument('--module-chat-prior-campaign-strategy-ledger-file', type=str,
                        default=None,
                        help='Optional prior science campaign strategy ledger JSON path')
    parser.add_argument('--module-chat-hypothesis-ledger-file', type=str,
                        default=None,
                        help='Optional plain JSON hypothesis evidence ledger')
    parser.add_argument('--module-chat-experiment-ledger-file', type=str,
                        default=None,
                        help='Optional plain JSON experiment/simulation request ledger')
    parser.add_argument('--module-chat-module-ledger-file', type=str,
                        default=None,
                        help='Optional plain JSON module-chat evidence ledger')
    parser.add_argument('--module-chat-campaign-strategy-outbox-file', type=str,
                        default='tmp/module-chat-science-campaign-strategy-outbox.jsonl',
                        help='JSONL path for at most one science campaign strategy response')
    parser.add_argument('--module-chat-campaign-strategy-outcome-ledger-file', type=str,
                        default='tmp/module-chat-science-campaign-strategy-outcome-ledger.json',
                        help='JSON path for science campaign strategy outcome assessor state')
    parser.add_argument('--module-chat-prior-campaign-strategy-outcome-ledger-file', type=str,
                        default=None,
                        help='Optional prior science campaign strategy outcome ledger JSON path')
    ...
    parser.add_argument('--module-chat-campaign-cycle-memory-ledger-file', type=str,
                        default=None,
                        help='Optional plain JSON campaign-cycle-memory ledger to read without mutation')
    parser.add_argument('--module-chat-campaign-cycle-strategy-outcome-ledger-file', type=str,
                        default='tmp/module-chat-science-campaign-cycle-strategy-outcome-ledger.json',
                        help='JSON path for science campaign cycle strategy outcome state')
    parser.add_argument('--module-chat-prior-campaign-cycle-strategy-outcome-ledger-file', type=str,
                        default=None,
                        help='Optional prior science campaign cycle strategy outcome ledger JSON path')
    parser.add_argument('--module-chat-campaign-cycle-strategy-outcome-outbox-file', type=str,
                        default='tmp/module-chat-science-campaign-cycle-strategy-outcome-outbox.jsonl',
                        help='JSONL path for at most one science campaign cycle strategy outcome response')
    parser.add_argument('--module-chat-science-history-ledger-file', type=str,
                        default='tmp/module-chat-science-coordination-history-ledger.json',
                        help='JSON path for science coordination history export state')
    parser.add_argument('--module-chat-prior-science-history-ledger-file', type=str,
                        default=None,
                        help='Optional prior science coordination history ledger JSON path')
    parser.add_argument('--module-chat-science-history-outbox-file', type=str,
                        default='tmp/module-chat-science-coordination-history-outbox.jsonl',
                        help='JSONL path for at most one science coordination history message')
    parser.add_argument('--module-chat-science-policy-ledger-file', type=str,
                        default='tmp/module-chat-science-coordination-policy-ledger.json',
                        help='JSON path for science coordination policy state')
    parser.add_argument('--module-chat-prior-science-policy-ledger-file', type=str,
                        default=None,
                        help='Optional prior science coordination policy ledger JSON path')
    parser.add_argument('--module-chat-science-policy-outbox-file', type=str,
                        default='tmp/module-chat-science-coordination-policy-outbox.jsonl',
                        help='JSONL path for at most one science coordination policy message')
    parser.add_argument('--module-chat-science-policy-outcome-ledger-file', type=str,
                        default='tmp/module-chat-science-coordination-policy-outcome-ledger.json',
                        help='JSON path for science coordination policy outcome state')
    parser.add_argument('--module-chat-prior-science-policy-outcome-ledger-file', type=str,
                        default=None,
                        help='Optional prior science coordination policy outcome ledger JSON path')
    ...
    parser.add_argument('--module-chat-science-ab-probe-ledger-file', type=str,
                        default='tmp/module-chat-science-coordination-ab-probe-ledger.json',
                        help='JSON path for science coordination A/B probe state')
    parser.add_argument('--module-chat-prior-science-ab-probe-ledger-file', type=str,
                        default=None,
                        help='Optional prior science coordination A/B probe ledger JSON path')
    parser.add_argument('--module-chat-science-ab-probe-outbox-file', type=str,
                        default='tmp/module-chat-science-coordination-ab-probe-outbox.jsonl',
                        help='JSONL path for at most one science coordination A/B probe message')
    parser.add_argument('--module-chat-science-ab-probe-outcome-ledger-file', type=str,
                        default='tmp/module-chat-science-coordination-ab-probe-outcome-ledger.json',
                        help='JSON path for science coordination A/B probe outcome state')
    parser.add_argument('--module-chat-prior-science-ab-probe-outcome-ledger-file', type=str,
                        default=None,
                        help='Optional prior science coordination A/B probe outcome ledger JSON path')
    ...
    parser.add_argument('--module-chat-science-history-guided-policy-ledger-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-ledger.json',
                        help='JSON path for science history-guided policy state')
    parser.add_argument('--module-chat-prior-science-history-guided-policy-ledger-file', type=str,
                        default=None,
                        help='Optional prior science history-guided policy ledger JSON path')
    parser.add_argument('--module-chat-science-history-guided-policy-outbox-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-outbox.jsonl',
                        help='JSONL path for at most one science history-guided policy message')
    parser.add_argument('--module-chat-science-history-guided-policy-outcome-ledger-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-outcome-ledger.json',
                        help='JSON path for science history-guided policy outcome state')
    parser.add_argument('--module-chat-prior-science-history-guided-policy-outcome-ledger-file', type=str,
                        default=None,
                        help='Optional prior science history-guided policy outcome ledger JSON path')
    parser.add_argument('--module-chat-science-history-guided-policy-outcome-outbox-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-outcome-outbox.jsonl',
                        help='JSONL path for at most one science history-guided policy outcome message')
    parser.add_argument('--module-chat-science-history-guided-policy-retention-ledger-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-retention-ledger.json',
                        help='JSON path for science history-guided policy retention scorecard state')
    parser.add_argument('--module-chat-prior-science-history-guided-policy-retention-ledger-file', type=str,
                        default=None,
                        help='Optional prior science history-guided policy retention ledger JSON path')
    parser.add_argument('--module-chat-science-history-guided-policy-retention-outbox-file', type=str,
                        default='tmp/module-chat-science-history-guided-policy-retention-outbox.jsonl',
                        help='JSONL path for at most one science history-guided policy retention message')
    parser.add_argument('--module-chat-science-retained-policy-replay-ledger-file', type=str,
                        default='tmp/module-chat-science-retained-policy-replay-ledger.json',
                        help='JSON path for science retained-policy replay state')
    parser.add_argument('--module-chat-prior-science-retained-policy-replay-ledger-file', type=str,
                        default=None,
                        help='Optional prior science retained-policy replay ledger JSON path')
    parser.add_argument('--module-chat-science-retained-policy-replay-outbox-file', type=str,
                        default='tmp/module-chat-science-retained-policy-replay-outbox.jsonl',
                        help='JSONL path for at most one science retained-policy replay message')
    ...
    if args.module_chat_science_campaign_strategy:
        run_science_campaign_strategy_planner(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            frontier_outcome_ledger_file=args.module_chat_frontier_outcome_ledger_file,
            ...
            prior_strategy_ledger_file=args.module_chat_prior_campaign_strategy_ledger_file,
            outbox_file=args.module_chat_campaign_strategy_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_campaign_strategy_outcome:
        run_science_campaign_strategy_outcome_assessor(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            strategy_ledger_file=args.module_chat_campaign_strategy_ledger_file,
    ...
    if args.module_chat_science_campaign_cycle_strategy_outcome:
        run_science_campaign_cycle_strategy_outcome_assessor(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            cycle_strategy_ledger_file=args.module_chat_campaign_cycle_strategy_ledger_file,
            ...
            prior_cycle_strategy_outcome_ledger_file=args.module_chat_prior_campaign_cycle_strategy_outcome_ledger_file,
            outbox_file=args.module_chat_campaign_cycle_strategy_outcome_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_coordination_history:
        run_science_coordination_history_exporter(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            cycle_strategy_outcome_ledger_file=args.module_chat_campaign_cycle_strategy_outcome_ledger_file,
            ...
            prior_history_ledger_file=args.module_chat_prior_science_history_ledger_file,
            outbox_file=args.module_chat_science_history_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_coordination_policy:
        run_science_coordination_policy_recommender(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            history_ledger_file=args.module_chat_science_history_ledger_file,
            ...
            prior_policy_ledger_file=args.module_chat_prior_science_policy_ledger_file,
            outbox_file=args.module_chat_science_policy_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_coordination_policy_outcome:
        run_science_coordination_policy_outcome_assessor(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            policy_ledger_file=args.module_chat_science_policy_ledger_file,
    ...
    if args.module_chat_science_coordination_ab_probe:
        run_science_coordination_ab_probe_planner(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            scorecard_ledger_file=args.module_chat_science_policy_scorecard_ledger_file,
            ...
            prior_ab_probe_ledger_file=args.module_chat_prior_science_ab_probe_ledger_file,
            outbox_file=args.module_chat_science_ab_probe_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_coordination_ab_probe_outcome:
        run_science_coordination_ab_probe_outcome_assessor(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            ab_probe_ledger_file=args.module_chat_science_ab_probe_ledger_file,
    ...
    if args.module_chat_science_history_guided_policy:
        run_science_history_guided_policy_planner(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            interaction_history_ledger_file=args.module_chat_science_interaction_history_ledger_file,
            ...
            experiment_ledger_file=args.module_chat_experiment_ledger_file,
            module_chat_ledger_file=args.module_chat_module_ledger_file,
            history_guided_policy_ledger_file=args.module_chat_science_history_guided_policy_ledger_file,
            prior_history_guided_policy_ledger_file=args.module_chat_prior_science_history_guided_policy_ledger_file,
            outbox_file=args.module_chat_science_history_guided_policy_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_history_guided_policy_outcome:
        run_science_history_guided_policy_outcome_assessor(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            history_guided_policy_ledger_file=args.module_chat_science_history_guided_policy_ledger_file,
            ...
            experiment_ledger_file=args.module_chat_experiment_ledger_file,
            module_chat_ledger_file=args.module_chat_module_ledger_file,
            history_guided_policy_outcome_ledger_file=args.module_chat_science_history_guided_policy_outcome_ledger_file,
            prior_history_guided_policy_outcome_ledger_file=args.module_chat_prior_science_history_guided_policy_outcome_ledger_file,
            outbox_file=args.module_chat_science_history_guided_policy_outcome_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_history_guided_policy_retention:
        run_science_history_guided_policy_retention_scorecard(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            history_guided_policy_outcome_ledger_file=args.module_chat_science_history_guided_policy_outcome_ledger_file,
            ...
            experiment_ledger_file=args.module_chat_experiment_ledger_file,
            module_chat_ledger_file=args.module_chat_module_ledger_file,
            retention_ledger_file=args.module_chat_science_history_guided_policy_retention_ledger_file,
            prior_retention_ledger_file=args.module_chat_prior_science_history_guided_policy_retention_ledger_file,
            outbox_file=args.module_chat_science_history_guided_policy_retention_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)

    if args.module_chat_science_retained_policy_replay:
        run_science_retained_policy_replay_evaluator(
            theory_memory=theory_memory,
            theory_memory_file=args.theory_memory_file,
            transcript_file=args.module_chat_inbox,
            retention_ledger_file=args.module_chat_science_history_guided_policy_retention_ledger_file,
            ...
            experiment_ledger_file=args.module_chat_experiment_ledger_file,
            module_chat_ledger_file=args.module_chat_module_ledger_file,
            replay_ledger_file=args.module_chat_science_retained_policy_replay_ledger_file,
            prior_replay_ledger_file=args.module_chat_prior_science_retained_policy_replay_ledger_file,
            outbox_file=args.module_chat_science_retained_policy_replay_outbox_file,
            output_file=args.module_chat_output_file or args.hf_output_file,
        )
        raise SystemExit(0)
